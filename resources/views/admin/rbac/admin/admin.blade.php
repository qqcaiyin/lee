...
@section('content')
	...
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe62b;</i> 权限管理 <span class="c-gray en">/</span>管理员列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
